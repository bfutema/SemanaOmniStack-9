...
function SpotList({tech, navigation}) {
  ...
  useEffect(() => {
    async function loadSpots() {
      ...
      response.data.map(spot => {
        spot.thumbnail_url = spot.thumbnail_url.replace('localhost', '192.168.56.1');
      });
  ...
  function renderImage() {
    return 'http://192.168.56.1:3333/files/WallpaperOmniStack-2560x1080-1570320871931.png';
  }
